...
class SingleDrawerBlockEntity(pos: BlockPos, state: BlockState) :
    BlockEntity(ModBlockEntities.SINGLE_DRAWER_BLOCK_ENTITY, pos, state), NamedScreenHandlerFactory, IInventory {
    ...
    override fun supports(state: BlockState): Boolean = RegistryHelper.Blocks.SINGLE_DRAWERS.contains(state.block)
    ...
    override fun createMenu(syncId: Int, playerInventory: PlayerInventory, player: PlayerEntity): ScreenHandler {
        return SingleDrawerScreenHandler(syncId, playerInventory, this, this.boxIndex)
    }
    ...
    override fun getDisplayName(): Text = Text.translatable(Constants.Translatable.SINGLE_DRAWER)
