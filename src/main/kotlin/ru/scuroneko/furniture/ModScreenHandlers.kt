...
import ru.scuroneko.furniture.carpenter.gui.BedsideTableScreenHandler
...
object ModScreenHandlers {
    ...
    fun register() {
        ...
        CARPENTER_TABLE_SCREEN_HANDLER = register(Identifier(ScuroFurniture.CARPENTER_MOD_ID, "carpenter_table"), ::CarpenterTableScreenHandler)
        MEDICAL_DRAWER_SCREEN_HANDLER = register(Identifier(ScuroFurniture.CARPENTER_MOD_ID, "medical_drawer"), ::MedicalDrawerScreenHandler)
        BEDSIDE_TABLE_SCREEN_HANDLER = register(Identifier(ScuroFurniture.CARPENTER_MOD_ID, "bedside_table"), ::BedsideTableScreenHandler)
    }

    private fun <T: ScreenHandler> register(id: Identifier, factory: ScreenHandlerType.Factory<T>): ScreenHandlerType<T> {
