...
//        ROAD_WORKER_STATION_SCREEN_HANDLER = register(Identifier(ScuroFurniture.ROADS_MOD_ID, "road_worker_station"), ::RoadWorkerStationScreenHandler)
        ...
        CARPENTER_TABLE_SCREEN_HANDLER = register(Identifier(ScuroFurniture.MOD_ID, "carpenter_table"), ::CarpenterTableScreenHandler)
        MEDICAL_DRAWER_SCREEN_HANDLER = register(Identifier(ScuroFurniture.MOD_ID, "medical_drawer"), ::MedicalDrawerScreenHandler)
        BEDSIDE_TABLE_SCREEN_HANDLER = register(Identifier(ScuroFurniture.MOD_ID, "bedside_table"), ::BedsideTableScreenHandler)
    }
