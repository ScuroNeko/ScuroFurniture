...
class RussianLangProvider(output: FabricDataOutput): FabricLanguageProvider(output, "ru_ru") {
    override fun generateTranslations(builder: TranslationBuilder) {
        ...
        builder.add(ModItems.OAK_MEDICAL_DRAWER_BOX, "Дубовый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_OAK_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного дубового бревна")
        ...
        builder.add(ModItems.SPRUCE_MEDICAL_DRAWER_BOX, "Еловый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_SPRUCE_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного елового бревна")
        ...
        builder.add(ModItems.BIRCH_MEDICAL_DRAWER_BOX, "Березовый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_BIRCH_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного березового бревна")
        ...
        builder.add(ModItems.JUNGLE_MEDICAL_DRAWER_BOX, "Тропический ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_JUNGLE_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного тропического бревна")
        ...
        builder.add(ModItems.ACACIA_MEDICAL_DRAWER_BOX, "Акациевый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_ACACIA_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного акациевого бревна")
        ...
        builder.add(ModItems.DARK_OAK_MEDICAL_DRAWER_BOX, "Ящик для медикаментов из темного дуба")
        ...
        builder.add(ModItems.STRIPPED_DARK_OAK_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного бревна темного дуба")
        ...
        builder.add(ModBlocks.STRIPPED_DARK_OAK_LOG_MEDICAL_DRAWER, "Аптечный шкафчик из обтесанного бревна темного дуба")

        builder.add(ModItems.MANGROVE_MEDICAL_DRAWER_BOX, "Мангровый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_MANGROVE_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного мангрового бревна")
        ...
        builder.add(ModItems.CHERRY_MEDICAL_DRAWER_BOX, "Вишневый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_CHERRY_LOG_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного вишневого бревна")
        ...
        builder.add(ModItems.BAMBOO_MEDICAL_DRAWER_BOX, "Бамбуковый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_BAMBOO_BLOCK_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из обтесанного бамбукового блока")
        ...
        builder.add(ModItems.CRIMSON_MEDICAL_DRAWER_BOX, "Багровый ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_CRIMSON_STEM_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из очищенного багрового стебля")
        ...
        builder.add(ModItems.WARPED_MEDICAL_DRAWER_BOX, "Искаженный ящик для медикаментов")
        ...
        builder.add(ModItems.STRIPPED_WARPED_STEM_MEDICAL_DRAWER_CASE, "Корпус аптечного ящика из очищенного искаженного стебля")
