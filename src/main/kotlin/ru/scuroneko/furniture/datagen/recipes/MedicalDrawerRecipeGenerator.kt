...
object MedicalDrawerRecipeGenerator {
    fun generate(exporter: FurnitureRecipeExporter) {
        ...
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.OAK_MEDICAL_BOX, Blocks.OAK_SLAB
        )
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.OAK_MEDICAL_BOX, ModItems.OAK_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.OAK_LOG_MEDICAL_DRAWER,
            ModItems.OAK_MEDICAL_BOX, ModItems.OAK_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_OAK_LOG_MEDICAL_DRAWER,
            ModItems.OAK_MEDICAL_BOX, ModItems.STRIPPED_OAK_LOG_MEDICAL_DRAWER_CASE
        )

        // Spruce medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.SPRUCE_MEDICAL_BOX, Blocks.SPRUCE_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.SPRUCE_MEDICAL_BOX, ModItems.SPRUCE_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.SPRUCE_LOG_MEDICAL_DRAWER,
            ModItems.SPRUCE_MEDICAL_BOX, ModItems.SPRUCE_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_SPRUCE_LOG_MEDICAL_DRAWER,
            ModItems.SPRUCE_MEDICAL_BOX, ModItems.STRIPPED_SPRUCE_LOG_MEDICAL_DRAWER_CASE
        )

        // Birch medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.BIRCH_MEDICAL_BOX, Blocks.BIRCH_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.BIRCH_MEDICAL_BOX, ModItems.BIRCH_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.BIRCH_LOG_MEDICAL_DRAWER,
            ModItems.BIRCH_MEDICAL_BOX, ModItems.BIRCH_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_BIRCH_LOG_MEDICAL_DRAWER,
            ModItems.BIRCH_MEDICAL_BOX, ModItems.STRIPPED_BIRCH_LOG_MEDICAL_DRAWER_CASE
        )

        // Jungle medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.JUNGLE_MEDICAL_BOX, Blocks.JUNGLE_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.JUNGLE_MEDICAL_BOX, ModItems.JUNGLE_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.JUNGLE_LOG_MEDICAL_DRAWER,
            ModItems.JUNGLE_MEDICAL_BOX, ModItems.JUNGLE_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_JUNGLE_LOG_MEDICAL_DRAWER,
            ModItems.JUNGLE_MEDICAL_BOX, ModItems.STRIPPED_JUNGLE_LOG_MEDICAL_DRAWER_CASE
        )

        // Acacia medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.ACACIA_MEDICAL_BOX, Blocks.ACACIA_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.ACACIA_MEDICAL_BOX, ModItems.ACACIA_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.ACACIA_LOG_MEDICAL_DRAWER,
            ModItems.ACACIA_MEDICAL_BOX, ModItems.ACACIA_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_ACACIA_LOG_MEDICAL_DRAWER,
            ModItems.ACACIA_MEDICAL_BOX, ModItems.STRIPPED_ACACIA_LOG_MEDICAL_DRAWER_CASE
        )

        // Dark oak medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.DARK_OAK_MEDICAL_BOX, Blocks.DARK_OAK_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.DARK_OAK_MEDICAL_BOX, ModItems.DARK_OAK_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.DARK_OAK_LOG_MEDICAL_DRAWER,
            ModItems.DARK_OAK_MEDICAL_BOX, ModItems.DARK_OAK_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_DARK_OAK_LOG_MEDICAL_DRAWER,
            ModItems.DARK_OAK_MEDICAL_BOX, ModItems.STRIPPED_DARK_OAK_LOG_MEDICAL_DRAWER_CASE
        )

        // Mangrove medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.MANGROVE_MEDICAL_BOX, Blocks.MANGROVE_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.MANGROVE_MEDICAL_BOX, ModItems.MANGROVE_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.MANGROVE_LOG_MEDICAL_DRAWER,
            ModItems.MANGROVE_MEDICAL_BOX, ModItems.MANGROVE_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_MANGROVE_LOG_MEDICAL_DRAWER,
            ModItems.MANGROVE_MEDICAL_BOX, ModItems.STRIPPED_MANGROVE_LOG_MEDICAL_DRAWER_CASE
        )

        // Cherry medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.CHERRY_MEDICAL_BOX, Blocks.CHERRY_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.CHERRY_MEDICAL_BOX, ModItems.CHERRY_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.CHERRY_LOG_MEDICAL_DRAWER,
            ModItems.CHERRY_MEDICAL_BOX, ModItems.CHERRY_LOG_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_CHERRY_LOG_MEDICAL_DRAWER,
            ModItems.CHERRY_MEDICAL_BOX, ModItems.STRIPPED_CHERRY_LOG_MEDICAL_DRAWER_CASE
        )

        // Bamboo medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.BAMBOO_MEDICAL_BOX, Blocks.BAMBOO_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.BAMBOO_MEDICAL_BOX, ModItems.BAMBOO_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.BAMBOO_BLOCK_MEDICAL_DRAWER,
            ModItems.BAMBOO_MEDICAL_BOX, ModItems.BAMBOO_BLOCK_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_BAMBOO_BLOCK_MEDICAL_DRAWER,
            ModItems.BAMBOO_MEDICAL_BOX, ModItems.STRIPPED_BAMBOO_BLOCK_MEDICAL_DRAWER_CASE
        )

        // Crimson medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.CRIMSON_MEDICAL_BOX, Blocks.CRIMSON_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.CRIMSON_MEDICAL_BOX, ModItems.CRIMSON_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.CRIMSON_STEM_MEDICAL_DRAWER,
            ModItems.CRIMSON_MEDICAL_BOX, ModItems.CRIMSON_STEM_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_CRIMSON_STEM_MEDICAL_DRAWER,
            ModItems.CRIMSON_MEDICAL_BOX, ModItems.STRIPPED_CRIMSON_STEM_MEDICAL_DRAWER_CASE
        )

        // Warped medical drawer
        exporter.createMedicalDrawerBoxRecipe(
            ModItems.WARPED_MEDICAL_BOX, Blocks.WARPED_SLAB
        )
        exporter.createMedicalDrawerCaseRecipe(
        ...
        exporter.createMedicalDrawerRecipe(
            ...
            ModItems.WARPED_MEDICAL_BOX, ModItems.WARPED_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.WARPED_STEM_MEDICAL_DRAWER,
            ModItems.WARPED_MEDICAL_BOX, ModItems.WARPED_STEM_MEDICAL_DRAWER_CASE
        )
        exporter.createMedicalDrawerRecipe(
            ModBlocks.STRIPPED_WARPED_STEM_MEDICAL_DRAWER,
            ModItems.WARPED_MEDICAL_BOX, ModItems.STRIPPED_WARPED_STEM_MEDICAL_DRAWER_CASE
        )
    }
}