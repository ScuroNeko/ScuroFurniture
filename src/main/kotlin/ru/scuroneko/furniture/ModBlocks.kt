...
object ModBlocks {
    ...
    val BAMBOO_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.BAMBOO_PLANKS))
    val BAMBOO_BLOCK_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.BAMBOO_PLANKS))
    val STRIPPED_BAMBOO_BLOCK_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.BAMBOO_PLANKS))

    val CRIMSON_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.CRIMSON_PLANKS))
    val CRIMSON_STEM_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.CRIMSON_STEM))
    val STRIPPED_CRIMSON_STEM_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.CRIMSON_STEM))

    val WARPED_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.WARPED_PLANKS))
    val WARPED_STEM_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.WARPED_STEM))
    val STRIPPED_WARPED_STEM_MEDICAL_DRAWER = MedicalDrawerBlock(FabricBlockSettings.copy(Blocks.STRIPPED_WARPED_STEM))
    ...
    val WHITE_CHERRY_KITCHEN_DRAWER = KitchenDrawerBlock(FabricBlockSettings.copy(Blocks.CHERRY_PLANKS))

    val CHERRY_KITCHEN_CABINET = KitchenCabinetBlock(FabricBlockSettings.copy(Blocks.CHERRY_PLANKS))
    ...
    private fun registerKitchenDrawer(path: String, block: KitchenDrawerBlock) {
        ScuroFurnitureBlocksAPI.registerKitchenDrawer(
            Identifier(ScuroFurniture.MOD_ID, path),
            block
        )
        BLOCKS[Identifier(ScuroFurniture.MOD_ID, path)] = block
    }
    ...
    private fun <T: BlockEntity> registerBlockEntity(path: String, blockEntity: BlockEntityType<T>) {
        Registry.register(
            Registries.BLOCK_ENTITY_TYPE, Identifier(ScuroFurniture.MOD_ID, path),
            blockEntity
        )
    }
}