...
class MedicalDrawerScreenHandler(syncId: Int, playerInventory: PlayerInventory, private val inventory: Inventory, boxIndex: Int) : ScreenHandler(ModScreenHandlers.MEDICAL_DRAWER_SCREEN_HANDLER, syncId) {
    constructor(syncId: Int, playerInventory: PlayerInventory) : this(syncId, playerInventory, SimpleInventory(4*9), 0)
